...
export const CreateEditProjectModal: React.FC<CreateEditProjectModalProps> = ({ isOpen, project, onSave, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-fuchsia-500/30 rounded-2xl shadow-2xl p-6 w-full max-w-lg space-y-4 animate-fade-in">
        <h2 className="text-2xl font-bold gradient-text">{isEditing ? 'Edit Project' : 'Create New Project'}</h2>
